...
@php
    ...
    switch ($variant) {
        case 'primary':
            $variantClasses = 'bg-gray-700 text-white hover:text-white hover:bg-gray-900 focus:ring-gray-900 dark:hover:bg-dark-eval-3';
        break;
        case 'secondary':
        ...
        break;
        default:
            $variantClasses = 'bg-gray-300 text-white hover:bg-gray-600 focus:ring-gray-500';
    }
